  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t">
      ...
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        ...
        <div className="flex gap-3">
          <input onChange={onChangeHandler} required name="zipcode" value={formData.zipcode} type="number" placeholder="Zipcode" className="border border-gray-300 rounded px-3.5 py-1.5 w-full"/>
        ...
        <input onChange={onChangeHandler} required name="phone" value={formData.phone} type="number" placeholder="Phone" className="border border-gray-300 rounded px-3.5 py-1.5 w-full"/>
